...
import 'package:gdlibrary_a_1394/pdf_view.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String id = const Uuid().v1(); //membuat kode unik berdasarkan waktu
  File? image;

  //List yang nantinya jadi value dari produknya
  ...
  //bagian mengatur button untuk membuat PDF
