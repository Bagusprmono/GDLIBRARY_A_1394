...
import 'package:gdlibrary_a_1394/invoice/get_total_invoice.dart';
import 'package:gdlibrary_a_1394/invoice/model/custom_row_invoice.dart';
import 'package:gdlibrary_a_1394/invoice/model/product.dart';
import 'package:barcode_widget/barcode_widget.dart';
import 'package:gdlibrary_a_1394/preview_screen.dart';
import 'package:gdlibrary_a_1394/invoice/item_doc.dart';
...
Future<void> createPdf(
  ...
  pw.ImageProvider pdfImageProvider(Uint8List imageBytse) {
    return pw.MemoryImage(imageBytse);
  }
...
pw.Padding imageFormInput(
    pw.ImageProvider Function(Uint8List imageBytse) pdfImageProvider,
...
pw.Padding personalDataFormInput(
    TextEditingController nameController,
    TextEditingController phoneController,
    TextEditingController addressController) {
  return pw.Padding(
        ...
        pw.Expanded(
          child: pw.Container(
            ...
            padding: const pw.EdgeInsets.only(
                left: 40.0, top: 10.0, bottom: 10.0, right: 40.0),
            alignment: pw.Alignment.centerLeft,
            child: pw.DefaultTextStyle(
              style:
                  const pw.TextStyle(color: PdfColors.amber100, fontSize: 12.0),
              child: pw.GridView(
                crossAxisCount: 2,
                children: [
...
pw.Padding contentOfInvoice(pw.Widget table) {
  return pw.Padding(
    ...
    child: pw.Column(
      children: [
        pw.Text(
            'Dear Customer thank you for buying our product, we hope the product can make yout day.'),
        table,
        pw.SizedBox(height: 3.h),
        pw.Text('Thanks for youur trust, and till the next time'),
        pw.SizedBox(height: 3.h),
